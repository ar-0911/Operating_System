...
int main(){
    ...
    //arranging them in the array based on their BURST time
    ...
    for(i=0;i<n;i++){
        ...
        p[i].waiting_time = gantt_time[i] - p[i].arrival_time;
    ...
    for(i=0;i<n;i++){
       ...
       printf("|     p%d      |       %02d          |       %02d        |        %02d        |          %02d             |\n",p[i].num,p[i].arrival_time,p[i].burst_time,p[i].waiting_time,p[i].taround_time);
